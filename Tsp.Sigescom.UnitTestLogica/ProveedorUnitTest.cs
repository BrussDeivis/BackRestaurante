...
{
    /// <summary>
    /// Descripción resumida de ProveedorUnitTest
    /// </summary>
    [TestClass]
    public class ProveedorUnitTest
    {
        ...
        public void obtenerProveedoresTestMethod()
        {
            var listaProveedores = logica.ObtenerProveedores();
            Assert.IsNotNull(listaProveedores);
        }
    }
}
