app.controller('reportesEjemploController', function ($scope, $q, $rootScope, DTOptionsBuilder, DTColumnDefBuilder, cocheraService) {
    ...
    $scope.actualizarURLReporteDeIngresosYSalidas = function () {
        ...
        $scope.URLReporteDeIngresosYSalidas = URL_ + "/Ejemplo/ReporteIngresosYSalidas?idCochera=" + $scope.cocheraSeleccionada.Id + "&nombreCochera=" + $scope.cocheraSeleccionada.Nombre + "&desde=" + (new Date($scope.fechaHoraInicio)).toUTCString() + "&hasta=" + (new Date($scope.fechaHoraFin)).toUTCString();
    }

    $scope.actualizarURLReporteDeVehiculosIngresados = function () {
        $scope.URLReporteDeVehiculosIngresados = URL_ + "/Ejemplo/ReporteVehiculosIngresados?idCochera=" + $scope.cocheraSeleccionada.Id + "&nombreCochera=" + $scope.cocheraSeleccionada.Nombre;
    }

    $scope.actualizarURLReporteDeVehiculosExonerados = function () {
        $scope.URLReporteDeVehiculosExonerados = URL_ + "/Ejemplo/ReporteExoneraciones?idCochera=" + $scope.cocheraSeleccionada.Id + "&nombreCochera=" + $scope.cocheraSeleccionada.Nombre
    }
