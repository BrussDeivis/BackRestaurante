...
namespace Tsp.Sigescom.WebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        return RedirectToSeleccionarCentroDeAtencion(returnUrl);
                    }
                    else
                    {
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            //user.IdEmpleado = _logicaEmpleado.obtenerIdEmpleado(user.Id);
        ...
        private ActionResult RedirectToSeleccionarCentroDeAtencion(string returnUrl)
        {
            if (Url.IsLocalUrl(returnUrl))
            {
                return Redirect(returnUrl);
            ...
            //return RedirectToAction("Estadistica", "Escritorio");
            return RedirectToAction("SeleccionarCentroDeAtencion", "CentroDeAtencion");
        }
