...
namespace Tsp.Sigescom.WebApplication
{
    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            SmtpClient client = new SmtpClient(ConfigurationManager.AppSettings["mailServer"], int.Parse(ConfigurationManager.AppSettings["mailPort"]));
            //client.Port = 587;
            ...
            //return client.SendMailAsync("info@techsolperu.com", message.Destination, message.Subject, message.Body);
