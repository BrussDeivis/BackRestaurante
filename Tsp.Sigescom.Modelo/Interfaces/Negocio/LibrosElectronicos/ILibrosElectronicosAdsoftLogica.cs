...
{
    public interface ILibrosElectronicosAdsoftLogica
    {
        List<ReporteVentaClienteAdsoft> ObtenerLibrosElectronicosAdsoft(int idEmpleado, DateTime fechaDesde, DateTime fechaHasta);
    }
