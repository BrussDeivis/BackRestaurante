...
{
    public interface IConsultaDetalleTransaccion_Repositorio
    {

        IEnumerable<Detalle_transaccion> ObtenerDetalleTransaccion(int idActorNegocioInterno, int idTipoTransaccion, int idUltimoEstado, int[] idsConceptos);
