...
{
    public interface IEliminarDetalleTransaccion_Repositorio
    {
        OperationResult EliminarDetallesDeTransaccionMasivo(List<Detalle_transaccion> detallesDeTransaccion);
