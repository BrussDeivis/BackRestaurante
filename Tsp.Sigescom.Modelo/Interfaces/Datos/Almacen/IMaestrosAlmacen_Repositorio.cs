...
{
    public interface IMaestrosAlmacen_Repositorio
    {
        int[] ObtenerIdsConceptosComerciales();

        decimal ObtenerStockMinimo(int idConcepto);
        IEnumerable<ItemGenerico> ObtenerConceptosNegocioComercializablesBienes();
        IEnumerable<Familia_Concepto_Comercial> ObtenerFamiliasBienes();
        int[] ObtenerIdsAlmacenes();
